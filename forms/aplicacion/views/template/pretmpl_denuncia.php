...
<head>
	...
	<script type='text/javascript' src='/forms/assets/js/jquery-1.7.2.min.js'></script>
					...
					<div id="header-middle">
						...
						<div id="logo">
							...
							<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" width="550" height="150" id="banner_cabecera.swf">
								<param name="movie"  value="/web/wp-content/themes/col/images/banner_cabecera.swf" />
								<param name="quality" value="high" />
								<param name="wmode" value="transparent">
								<embed src="/web/wp-content/themes/col/images/banner_cabecera.swf" quality="high" width="550" height="150" name="mymoviename" align="" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>
							</object>
						</div>
						...
						<div id="header-banner">
							<form method="get" id="searchform" action="http://www.col.org.pe/web/">
								...
								<input type="image" src="/web/wp-content/themes/col/images/search-button.png" value="" id="search-button">
							</form>
						</div>
					...
					<div id="wrapper-navigation">
						...
						<div id="navigation">
							<div class="menu-main-container">
								...
								<li id="menu-item-48" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-48"><a href="/web/">Inicio</a></li>
								<li id="menu-item-47" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-47"><a href="/web/institucional/">Institucional</a>
									<ul class="sub-menu">
										<li id="menu-item-346" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-346"><a href="/web/institucional/leyes-y-normas/">Leyes y normas</a></li>
										<li id="menu-item-342" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-342"><a href="/web/institucional/programas-comisiones-y-comites/">Programas y Comisiones</a></li>
										<li id="menu-item-341" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-341"><a href="/web/institucional/cuota-societaria/">Cuota societaria</a></li>
										<li id="menu-item-340" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-340"><a href="/web/institucional/consentimiento-informado/">Consentimiento Informado</a></li>
										<li id="menu-item-330" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-330"><a href="/web/institucional/junta-electoral/">Junta Electoral</a></li>
									</ul>
								</li>
								<li id="menu-item-46" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-46"><a href="/web/publicaciones/">Publicaciones</a>
									<ul class="sub-menu">
										<li id="menu-item-94" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-94"><a href="/web/publicaciones/noticop-lima-digital/">NotiCOP-Lima Digital</a></li>
									</ul>
								</li>
								<li id="menu-item-45" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-45"><a href="/web/capacitacion/">Capacitación</a></li>
								<li id="menu-item-44" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-44"><a href="/web/nuevos/">Nuevos colegiados</a></li>
								<li id="menu-item-43" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-43"><a href="/web/servicios/">Servicios</a></li>
								<li id="menu-item-42" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-42"><a href="/web/sugerencias/">Sugerencias</a></li>
								</ul>
							</div>
						</div>
