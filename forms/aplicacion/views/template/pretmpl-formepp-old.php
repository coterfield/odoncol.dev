...
<head>
	...
	jQuery(window).load(function() {
		...
		jQuery.validator.addMethod("chekmulti", function(value, element) {
			var cheknam = jQuery(element).attr('id');
		//	alert(cheknam+": "+jQuery("#"+cheknam+" option:selected").length);
			return jQuery(cheknam+" option:selected").length > -1;
		//	return false;
		}, "Tienes que elegir algún curso.");
		...
		jQuery("#miraflores").rules("add", {
			required: true,
			minlength: 1,
			chekmulti: true,
			messages: {
				required: "Elejir al menos 1",
				minlength: "Elejir al menos 1",
				chekmulti: "Alije algo",
			}
		});

		jQuery("#comas").rules("add", {
			required: true,
			minlength: 1,
			chekmulti: true,
			messages: {
	...
	//	alert(jQuery("#nombres").attr('placeholder'));
	//	alert(jQuery("#nombres").val());
	//	alert(jQuery("#miraflores").attr("id"));
	//	alert(jQuery("#"+"miraflores"+" option:selected").length);
